...
/***/ "./public/assets/hulu-default.png":
/*!****************************************!*\
  !*** ./public/assets/hulu-default.png ***!
  \****************************************/
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "public/assets/hulu-default.png");
...
/* harmony import */ var _hulu_originals_display_remote_control__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../hulu-originals-display/remote-control */ "./src/hulu-originals-display/remote-control.ts");
...
const main = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    (0,_hulu_originals_display_remote_control__WEBPACK_IMPORTED_MODULE_1__.remote)();
});


/***/ }),

/***/ "./src/hulu-originals-display/remote-control.ts":
/*!******************************************************!*\
  !*** ./src/hulu-originals-display/remote-control.ts ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! .. */ "./src/index.ts");
/* harmony import */ var _hulu_originals_modal_hulu_originals_modal__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../hulu-originals-modal/hulu-originals-modal */ "./src/hulu-originals-modal/hulu-originals-modal.ts");
var __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
...
const remote = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const subtitle = document === null || document === void 0 ? void 0 : document.querySelectorAll('.subtitle');
...
/***/ "./src/hulu-originals-modal/hulu-originals-modal.ts":
/*!**********************************************************!*\
  !*** ./src/hulu-originals-modal/hulu-originals-modal.ts ***!
  \**********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const openModal = (i, x) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (defaultItems.length == 0) {
        data = yield (0,___WEBPACK_IMPORTED_MODULE_0__.getEmptyData)(defaultData.components[x].id);
        items = data.items[i];
    }
    else {
        data = yield (0,___WEBPACK_IMPORTED_MODULE_0__.getData)();
...
const getData = () => __awaiter(void 0, void 0, void 0, function* () {
    const requestURL = "https://d1q0vy0v52gyjr.cloudfront.net/hub.json";
    const request = new Request(requestURL);
    const response = yield fetch(request);
    const showData = yield response.json();
    return showData;
});
//hulu originals data by id
const getEmptyData = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const requestURL = `https://d1q0vy0v52gyjr.cloudfront.net/collections/${id}.json`;
    const request = new Request(requestURL);
    const response = yield fetch(request);
